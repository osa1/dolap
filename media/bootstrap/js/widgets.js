...
window.__twttrlr = (window.__twttrlr || loadrunner.noConflict());
__twttrlr(function(using, provide, loadrunner, define) {
  ...
  provide("tfw/widget/base", function(a) {
    using("util/util", "util/domready", "util/nodeselect", "util/querystring", "util/iframe", function(b, c, d, e, f) {
      ...
      var g = 0,
          ...
          "zh-tw": {
            "%{followers_count} followers": "%{followers_count} 位關注者",
            "100K+": "超過十萬",
            "10k unit": "1萬 單位",
            Follow: "關注",
            "Follow %{screen_name}": "關注 %{screen_name}",
            K: "千",
            M: "百萬",
            Tweet: "推文",
          ...
          he: {
            ...
            Follow: "מעקב",
            "Follow %{screen_name}": "מעקב אחר %{screen_name}",
            K: "אלף",
            M: "מיליון",
            Tweet: "ציוץ",
          ...
          pt: {
            ...
            Follow: "Seguir",
            "Follow %{screen_name}": "Siga %{screen_name}",
            K: "Mil",
            M: "M",
            Tweet: "Tweetar",
  ...
  provide("tfw/widget/tracking", function(a) {
    using("dom/cookie", "util/donottrack", "tfw/widget/guest_cookie", "tfw/widget/env", function(b, c, d, e) {
      function i(a, b, c) {
        var d = f + b;
        if (!a) return;
        return a[d] = c, a
      ...
      function j(a, f, j, k, l) {
        k || (k = !1), l || (l = !1), f || (f = {}), j = j || "tweetbutton", j = h[j] || h.tweetbutton;
  ...
  provide("tfw/widget/tweet", function(a) {
    using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "dom/textsize", function(b, c, d, e, f) {
      ...
      j.prototype = new c.Base, b.aug(j.prototype, {
        ...
        render: function(a) {
          var b = a.assetUrl() + "/widgets/tweet_button.1331069346.html#" + this.parameters();
    ...
    using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "dom/textsize", function(b, c, d, e, f) {
      ...
      g.prototype = new c.Base, b.aug(g.prototype, {
        ...
        render: function(a) {
          ...
          var b = a.assetUrl() + "/widgets/follow_button.1331069346.html#" + this.parameters();
